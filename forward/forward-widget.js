...
WidgetMetadata = {
  ...
  globalParams: [
    ...
    {
      name: "sourceOrder",
      title: "源排序配置，默认'douban,360,renren,hanjutv'，可选['360', 'vod', 'tmdb', 'douban', 'tencent', 'youku', 'iqiyi', 'imgo', 'bilibili', 'migu', 'acfun', 'sohu', 'leshi', 'xigua', 'maiduidui', 'aiyifan', 'renren', 'hanjutv', 'bahamut', 'dandan', 'custom']",
      type: "input",
      placeholders: [
        {
          title: "配置1",
    ...
    {
      name: "doubanCookie",
      title: "豆瓣Cookie（填入后可提升豆瓣搜索与部分详情请求稳定性）",
      type: "input",
      placeholders: [
        {
          title: "示例",
    ...
    {
      name: "platformOrder",
      title: "平台优选配置，可选['qiyi', 'bilibili1', 'imgo', 'youku', 'qq', 'migu', 'acfun', 'sohu', 'leshi', 'xigua', 'maiduidui', 'aiyifan', 'renren', 'hanjutv', 'bahamut', 'dandan', 'custom']",
      type: "input",
      placeholders: [
        {
          title: "配置1",
          value: "qq,qiyi,imgo,bilibili1,youku,migu,acfun,sohu,leshi,xigua,maiduidui,aiyifan,renren,hanjutv,bahamut,dandan,custom",
        },
        {
          title: "配置2",
    ...
    {
      name: "matchPlatformRules",
      title: "按剧名/季度配置自动匹配平台优先级，平台名沿用 PLATFORM_ORDER，不影响搜索源。格式：剧名->平台1,平台2;剧名/S01->平台1&平台2,平台3。文件名显式 @平台 优先级最高；配合剧名映射表时原始标题和映射后标题都可命中",
      type: "input",
      placeholders: [
        {
          title: "示例",
          value: "葬送的芙莉莲->dandan;葬送的芙莉莲/S01->bilibili1,animeko",
        },
      ],
    },
    {
...
async function initGlobals(sourceOrder, otherServer, customSourceApiUrl, vodServers, vodReturnMode, vodRequestTimeout, bilibiliCookie, doubanCookie,
                     platformOrder, matchPlatformRules, episodeTitleFilter, enableAnimeEpisodeFilter, strictTitleMatch, titleMappingTable, animeTitleFilter, animeTitleSimplified, blockedWords, groupMinute,
  ...
  if (matchPlatformRules !== undefined) env.MATCH_PLATFORM_RULES = matchPlatformRules;
